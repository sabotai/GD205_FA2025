...
public class Seek : MonoBehaviour
{
    ...
    void FixedUpdate()
    {   //trigger our seeker ...
        //only if the distance is between our seeker and our target is less than a certain proximity

        if (Vector3.Distance(transform.position, target.position) < proximityTrigger)
        {
